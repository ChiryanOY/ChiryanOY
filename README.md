...
> *Dedicate to innovation and application in the field of AI.*

<br/>

## 🔬 Research & Focus
My research is deeply rooted in **Generative Modeling** and the application of AI in **Quantitative Finance** (specifically Polymarket). I aim to bridge theoretical insights with practical, high-performance systems.
...
<details open>
<summary><b> 💻 System.Current() -> <code>class AI_Researcher</code></b></summary>
<br>
...
public:
    ...
    struct Skills {
        std::vector<std::string> languages = {"Python", "TypeScript", "C++", "Rust"};
        std::vector<std::string> ai_stack  = {"PyTorch", "JaX"};
        std::vector<std::string> interests = {"Generative Modeling", "Quant in Polymarket"};
    } skills;

    void execute() {
        std::cout << "Dedicate to innovation and application in the field of AI." << std::endl;
        std::cout << "Let's build the future." << std::endl;
    }
};
